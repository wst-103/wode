<template>
  <div class="dlkjj">
    <nydsj-chart style="width:58%;height:418px" :option="option" />
    <nydsj-chart style="width:58%;height:418px" :option="option2" />
  </div>
</template>

<script>
import NydsjChart from "@/components/NydsjChart.vue";
export default {
  components: {
    NydsjChart
  },
